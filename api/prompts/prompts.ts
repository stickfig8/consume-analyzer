...
- 금액(예: 120,000원)은 <money>...</money> 로 감싸세요(단위(원)도 포함).
- 소비 조절이 필요한 항목(candidates 포함 요소 중)은 <adjust>...</adjust> 로 감싸세요.
...
- 숫자를 계산하거나 변경하지 마세요.
- 금액일 경우 한국 기준 정규화(000,000)형식으로 기입해주세요.
...
- patternAnalysis에서는 단순 비율 뿐만 아니라 소비 구조적 특징에 대한 해석을 포함하세요.
